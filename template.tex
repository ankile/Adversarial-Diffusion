...
\title{Denoising Diffusion Model as Defense against Adversarial Attacks}
...
\author{ Lars Ankile\\
	...
	Anna Midgley \\
	Harvard University\\
	\texttt{anna@g.harvard.edu}
	\And
	Sebastian Weisshaar \\
	Harvard University \\
	\texttt{seb@g.harvard.edu} \\
}
...
\renewcommand{\shorttitle}{Denoising Diffusion Model as Defence against Adversarial Attacks}

%%% Add PDF metadata to help others organize their library
%%% Once the PDF is generated, you can check the metadata with
%%% $ pdfinfo template.pdf
\hypersetup{
pdftitle={Denoising Diffusion Model as Defence against Adversarial Attacks},
